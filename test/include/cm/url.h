...
//			std::cerr << std::endl;
//
//			std::cerr << separator_chars[PATH]     << " |=> " << first.positions[PATH] << std::endl;
//			std::cerr << separator_chars[QUERY]    << " |=> " << first.positions[QUERY] << std::endl;
//			std::cerr << separator_chars[FRAGMENT] << " |=> " << first.positions[FRAGMENT] << std::endl;
//			std::cerr << separator_chars[COLON]    << " |=> " << first.positions[COLON] << std::endl;
//			std::cerr << separator_chars[AT]       << " |=> " << first.positions[AT] << std::endl;
//
//		}
